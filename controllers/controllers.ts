//TODO List
//El mecánico quiere introducir los datos del coche
//A continuación introduce las ruedas y el tipo de rueda
//Lo printamos por pantalla

//VARIABLES
/*let car :Car;
let wheel :Wheel;
//buttons
let carButon   = (document.getElementById('cars') as HTMLElement);
let wheelButon = (document.getElementById('wheel') as HTMLElement);
//car elements
let newPlate  = (document.getElementById("plate") as HTMLFormElement).nodeValue;
...
//FUNCTIONS
function createCar(newPlate,newColor, newBrand){
...
//LISTENERS
carButon.addEventListener(`click`, createCar(newPlate,newColor, newBrand));*/